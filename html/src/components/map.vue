<template>
    <div>
        ...
        <div style="position: relative;left: 20%;width: auto;background-color:#5CADAD; border-radius:10px;" >
            <div id="mapTab">
                <div @click="switchCountryName(true)" style="background-color:#FFFFFF; border-radius:6px 6px 0px 0px;" >tab1</div>
                <div @click="switchCountryName(false)" style="background-color:#007979; border-radius:6px 6px 0px 0px;" >tab2</div>
                <br>
            </div>
            <br>
...
const StyleColor = {
    ...
    "recovered": ["FFE000","799f0c"],
    "deaths":["485563","29323c"]
}

const CovidMinMax = {
    "confirmed":[100,8000000],
    "recovered":[100,1000000],
    "deaths":[10,100000]
}
export default {
    name:"Map",
    ...
    methods:{
        ...
        getCovidData(){
            this.value = 0;
            let api = `${this.$host}/C_covid/world?start=${this.start}&end=${this.end}&flag=true`
            this.$http.get(api).then(response=>{
        ...
        infoContent(covid_data,countryData){
            ...
            <div class="card">
                <h2>${countryData.country_name}</h2>
                ...
                <div class="actions">
                    ...
                    <button class="actions__trade">${covid_data.recovered} &nbsp; <i class="fas fa-h-square"></i> </button>
